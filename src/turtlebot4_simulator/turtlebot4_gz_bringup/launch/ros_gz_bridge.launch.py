...
def generate_launch_description():
    ...
    imu_bridge = Node(
        ...
        name='tb4_imu_bridge',
        output='screen',
        arguments=['/tb4_imu@sensor_msgs/msg/Imu[gz.msgs.IMU'],
    )

    navsat_bridge = Node(
        package='ros_gz_bridge',
        executable='parameter_bridge',
        name='tb4_navsat_bridge',
        output='screen',
        arguments=['/tb4_navsat@sensor_msgs/msg/NavSatFix[gz.msgs.NavSat'],
    )
    ...
    ld.add_action(oakd_camera_bridge)
        ...
        # then add them to the LaunchDescription
    ld.add_action(imu_bridge)
    ld.add_action(navsat_bridge)
